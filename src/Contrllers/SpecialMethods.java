...
public class SpecialMethods {
    ...
    public static File getPathFile(String meterCode){
        return new File("G:\\computer science\\My Projects\\Electricity Billing System\\ElectricityBillingSystem\\src\\Files\\Customers\\"
                +meterCode+".txt");
    }
